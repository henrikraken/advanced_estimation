...
* such declarations are portable without corrections. 
      ...
      real (kind = double) :: scr(m_dim), scr2(n_dim+1)
...
*.....Upper triangularize h.
      ...
      call house_blas2( h_y, ldh, m, n, scr, scr2)
...
*.....Check elements of xhat.
 ...
 1400 format (// 1x, 'Householder BLAS2   :',
     >           1x, 'Ops = ',   1pe9.3,
     >           2x, 'Time = ',  1pe9.3, ' sec',
     >           2x, 'Speed = ', 1pe9.3, ' Mf'    )
 6000 format (// 1x, 'Total time=',   1p1e10.3,
     .           3x, 'Householder BLAS2: time=', 1p1e10.3,
